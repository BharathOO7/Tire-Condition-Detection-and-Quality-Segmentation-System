...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>TRMS | Washing Plans</title>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Tire Repair Booking</h4>
        </div>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">TIRE QUALITY CHECK ($10.99)</option>
                 <option value="2">TIRE INFLATING ($20.99)</option>
                  <option value="3 ">TIRE REPAIR($30.99)</option>
              </select>
